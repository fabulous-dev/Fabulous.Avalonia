...
module ComponentColorSpectrumBuilders =
    type Fabulous.Avalonia.Components.View with
        ...
        static member ColorSpectrum(color: Color, fn: Color -> unit) =
            WidgetBuilder<unit, IFabComponentColorSpectrum>(ColorSpectrum.WidgetKey, ComponentColorSpectrum.ColorChanged.WithValue(ComponentValueEventData.create color fn))
