...
type IFabComponentDataGrid =
    inherit IFabComponentTemplatedControl
    inherit IFabDataGrid

module ComponentDataGrid =
    let Columns =
        ComponentAttributes.defineAvaloniaNonGenericListWidgetCollection "DataGrid_Columns" (fun target -> (target :?> DataGrid).Columns :> IList)
...
module ComponentDataGridBuilders =
    type Fabulous.Avalonia.Components.View with
        ...
        static member DataGrid(items: #IEnumerable) =
            WidgetBuilder<unit, IFabComponentDataGrid>(DataGrid.WidgetKey, DataGrid.Items.WithValue(items), DataGrid.AutoGeneratedColumns.WithValue(true))
...
type ComponentDataGridModifiers =
    ...
    [<Extension>]
    static member inline onHorizontalScroll(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: ScrollEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onVerticalScroll(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: ScrollEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onAutoGeneratingColumn(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridAutoGeneratingColumnEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onBeginningEdit(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridBeginningEditEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onCellEditEnded(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridCellEditEndedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onCellEditEnding(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridCellEditEndingEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onCellPointerPressed(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridCellPointerPressedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onColumnDisplayIndexChanged(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridColumnEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onColumnReordered(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridColumnEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onColumnReordering(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridColumnReorderingEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onCurrentCellChanged(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: EventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onLoadingRow(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onPreparingCellForEdit(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridPreparingCellForEditEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onRowEditEnded(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowEditEndedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onRowEditEnding(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowEditEndingEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onSelectionChanged(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: SelectionChangedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onSorting(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridColumnEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onUnloadingRow(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onLoadingRowDetails(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowDetailsEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onRowDetailsVisibilityChanged(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowDetailsEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onUnloadingRowDetails(this: WidgetBuilder<unit, IFabComponentDataGrid>, fn: DataGridRowDetailsEventArgs -> unit) =
        this.AddScalar(ComponentDataGrid.UnloadingRowDetails.WithValue(fn))

type ComponentDataGridExtraModifiers =
    /// <summary>Sets the HorizontalGridLinesBrush property.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="value">The HorizontalGridLinesBrush value.</param>
    [<Extension>]
    static member inline horizontalGridLinesBrush(this: WidgetBuilder<unit, IFabComponentDataGrid>, value: Color) =
    ...
    /// <param name="value">The HorizontalGridLinesBrush value.</param>
    [<Extension>]
    static member inline horizontalGridLinesBrush(this: WidgetBuilder<unit, IFabComponentDataGrid>, value: string) =
    ...
    [<Extension>]
    static member inline rowBackground(this: WidgetBuilder<unit, IFabComponentDataGrid>, value: Color) =
    ...
    /// <param name="value">The RowBackground value.</param>
    [<Extension>]
    static member inline rowBackground(this: WidgetBuilder<unit, IFabComponentDataGrid>, value: string) =
    ...
    [<Extension>]
    static member inline verticalGridLinesBrush(this: WidgetBuilder<unit, IFabComponentDataGrid>, value: Color) =
    ...
    /// <param name="value">The VerticalGridLinesBrush value.</param>
    [<Extension>]
    static member inline verticalGridLinesBrush(this: WidgetBuilder<unit, IFabComponentDataGrid>, value: string) =
...
//     [<Extension>]
//     static member inline Yield<unit, 'marker, 'itemType when unit: equality and 'itemType :> IFabDataGridColumn>
//         (_: CollectionBuilder<unit, 'marker, IFabDataGridColumn>, x: WidgetBuilder<unit, 'itemType>)
//         : Content<unit> =
//         { Widgets = MutStackArray1.One(x.Compile()) }
//
//     [<Extension>]
//     static member inline Yield<unit, 'marker, 'itemType when unit: equality and 'itemType :> IFabDataGridColumn>
//         (_: CollectionBuilder<unit, 'marker, IFabDataGridColumn>, x: WidgetBuilder<unit, Memo.Memoized<'itemType>>)
//         : Content<unit> =
//         { Widgets = MutStackArray1.One(x.Compile()) }
