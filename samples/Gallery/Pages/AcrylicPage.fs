...
module ComponentAcrylicPage =

    let view () =
        Component("ComponentAcrylicPage") {
            let! tintOpacitySlider = Context.State(0.9)
            let! materialOpacitySlider = Context.State(0.8)
            let! borderWidth = Context.State(160.)
                    ...
                    VStack(0.) {
                        (Grid(coldefs = [ Auto; Star; Auto ], rowdefs = [ Auto ]) {
                            ...
                            Slider(
                                0.,
                                1.,
                                tintOpacitySlider.Current,
                                (fun args ->
                                    tintOpacitySlider.Set(args)
                            ...
                            TextBlock($"{Math.Round(tintOpacitySlider.Current, 2)}")
                                .gridColumn(2)
                                .style(Common.textBlockStyle)
                        })
                            .margin(20., 10.)
                        ...
                        (Grid(coldefs = [ Auto; Star; Auto ], rowdefs = [ Auto ]) {
                            ...
                            Slider(
                                0.,
                                1.,
                                materialOpacitySlider.Current,
                                fun args ->
                                    materialOpacitySlider.Set(args)
                            ...
                            TextBlock($"{Math.Round(materialOpacitySlider.Current, 2)}")
                                .gridColumn(2)
                                .style(Common.textBlockStyle)
                        })
                            .margin(20., 10.)
                    ...
                    ExperimentalAcrylicBorder()
                        .material(
                            ExperimentalAcrylicMaterial()
                                .backgroundSource(AcrylicBackgroundSource.Digger)
                                .tintColor(Color.Parse("#FF0000"))
                                .tintOpacity(tintOpacitySlider.Current)
                                .materialOpacity(materialOpacitySlider.Current)
                        )
                        .style(Common.acrylicBorderStyle1)
