...
module State =
    ...
    let init () =
        ...
        let implicitCanvasAnimationsModel, implicitCanvasAnimationsCmdMsgs = ImplicitCanvasAnimationsPage.init()
        let compositorAnimationsModel, compositorAnimationsCmdMsgs = CompositorAnimationsPage.init()
        ...
        let calendarDatePickerModel, calendarDatePickerCmdMsgs = CalendarDatePickerPage.init()
        ...
        let layoutTransformControlModel, layoutTransformControlCmdMsgs = LayoutTransformControlPage.init()
        let lineBoundsDemoControlModel, lineBoundsDemoControlCmdMsgs = LineBoundsDemoControlPage.init()
        ...
        let selectableTextBlockModel, selectableTextBlockCmdMsgs = SelectableTextBlockPage.init()
    ...
    let update msg model =
        ...
        | AdornerLayerPageMsg msg ->
            ...
            { model with AdornerLayerPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | AutoCompleteBoxPageMsg msg ->
            let model1, cmdMsgs = AutoCompleteBoxPage.update msg model.AutoCompleteBoxPageModel
            { model with AutoCompleteBoxPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | AnimationsPageMsg msg ->
            let model1, cmdMsgs = AnimationsPage.update msg model.AnimationsPageModel
            { model with AnimationsPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ImplicitCanvasAnimationsPageMsg msg -> 
            let model1, cmdMsgs = ImplicitCanvasAnimationsPage.update msg model.ImplicitCanvasAnimationsPageModel
            let cmdMsgs = [ Cmd.map SubpageCmdMsgs  cmdMsgs ]
            { model with ImplicitCanvasAnimationsPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | CompositorAnimationsPageMsg msg -> 
            let model1, cmdMsgs = CompositorAnimationsPage.update msg model.CompositorAnimationsPageModel
            { model with CompositorAnimationsPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ButtonsPageMsg msg -> 
        ...
        | ButtonSpinnerPageMsg msg -> 
            ...
            { model with ButtonSpinnerPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | BorderPageMsg msg -> 
        ...
        | CalendarPageMsg msg -> 
            ...
            { model with CalendarPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | CalendarDatePickerPageMsg msg -> 
            let model1, cmdMsgs = CalendarDatePickerPage.update msg model.CalendarDatePickerPageModel
            { model with CalendarDatePickerPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | CanvasPageMsg msg -> 
        ...
        | ExpanderPageMsg msg -> 
            ...
            { model with ExpanderPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | FlyoutPageMsg msg -> 
        ...
        | GesturesPageMsg msg -> 
            ...
            { model with GesturesPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | GeometriesPageMsg msg -> 
            let model1, cmdMsgs = GeometriesPage.update msg model.GeometriesPageModel
            { model with GeometriesPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | GridPageMsg msg -> 
        ...
        | GridSplitterPageMsg msg -> 
            ...
            { model with GridSplitterPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ImagePageMsg msg -> 
        ...
        | LayoutTransformControlPageMsg msg -> 
            let model1, cmdMsgs = LayoutTransformControlPage.update msg model.LayoutTransformControlPageModel
            { model with LayoutTransformControlPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | LineBoundsDemoControlPageMsg msg -> 
            let model1, cmdMsgs = LineBoundsDemoControlPage.update msg model.LineBoundsDemoControlPageModel
            { model with LineBoundsDemoControlPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ListBoxPageMsg msg -> 
        ...
        | MenuFlyoutPageMsg msg -> 
            ...
            { model with MenuFlyoutPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | MaskedTextBoxPageMsg msg -> 
            let model1, cmdMsgs = MaskedTextBoxPage.update msg model.MaskedTextBoxPageModel
            { model with MaskedTextBoxPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | MenuPageMsg msg -> 
        ...
        | NumericUpDownPageMsg msg -> 
            ...
            { model with NumericUpDownPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | NotificationsPageMsg msg -> 
            let model1, cmdMsgs = NotificationsPage.update msg model.NotificationsPageModel
            { model with NotificationsPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | OpenGLPageMsg msg -> 
        ...
        | ProgressBarPageMsg msg -> 
            ...
            { model with ProgressBarPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | PanelPageMsg msg -> 
        ...
        | PathIconPageMsg msg -> 
            ...
            { model with PathIconPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | PopupPageMsg msg -> 
        ...
        | PointersPageMsg msg -> 
            ...
            { model with PointersPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | PageTransitionsPageMsg msg -> 
            let model1, cmdMsgs = PageTransitionsPage.update msg model.PageTransitionsPageModel
            { model with PageTransitionsPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | RepeatButtonPageMsg msg -> 
            let model1, cmdMsgs = RepeatButtonPage.update msg model.RepeatButtonPageModel
            { model with RepeatButtonPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | RadioButtonPageMsg msg -> 
            let model1, cmdMsgs = RadioButtonPage.update msg model.RadioButtonPageModel
            { model with RadioButtonPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | RefreshContainerPageMsg msg -> 
            let model1, cmdMsgs = RefreshContainerPage.update msg model.RefreshContainerPageModel
            { model with RefreshContainerPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | SelectableTextBlockPageMsg msg -> 
            let model1, cmdMsgs = SelectableTextBlockPage.update msg model.SelectableTextBlockPageModel
            { model with SelectableTextBlockPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | SplitButtonPageMsg msg -> 
            let model1, cmdMsgs = SplitButtonPage.update msg model.SplitButtonPageModel
            { model with SplitButtonPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | SliderPageMsg msg -> 
        ...
        | ScrollViewerPageMsg msg -> 
            ...
            { model with ScrollViewerPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ToggleSplitButtonPageMsg msg -> 
            let model1, cmdMsgs = ToggleSplitButtonPage.update msg model.ToggleSplitButtonPageModel
            { model with ToggleSplitButtonPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | TextBlockPageMsg msg -> 
            let model1, cmdMsgs = TextBlockPage.update msg model.TextBlockPageModel
            { model with TextBlockPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | TextBoxPageMsg msg -> 
        ...
        | ToggleSwitchPageMsg msg -> 
            ...
            { model with ToggleSwitchPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ToggleButtonPageMsg msg -> 
            let model1, cmdMsgs = ToggleButtonPage.update msg model.ToggleButtonPageModel
            { model with ToggleButtonPageModel = model1 },  [ SubpageCmdMsgs cmdMsgs ]
        | ToolTipPageMsg msg -> 
