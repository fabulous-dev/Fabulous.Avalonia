...
module Types =
    type Model =
        { AcrylicPageModel: AcrylicPage.Model
          ...
          CursorPageModel: CursorPage.Model
          ...
          TreeDataGridPageModel: TreeDataGridPage.Model
    ...
    type Msg =
        ...
        | CursorPageMsg of CursorPage.Msg
        ...
        | TreeDataGridPageMsg of TreeDataGridPage.Msg
    ...
    type SubpageCmdMsg =
        ...
        | CursorPageCmdMsgs of CursorPage.CmdMsg list
        ...
        | TreeDataGridPageCmdMsgs of TreeDataGridPage.CmdMsg list
