...
type InputElementModifiers =
    ...
    /// <summary>Sets the IsEffectivelyEnabled property.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="value">The value to set.</param>
    [<Extension>]
    ...
    /// <summary>Sets the IsKeyboardFocusWithin property.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="value">The value to set.</param>
    [<Extension>]
    ...
    /// <summary>Sets the IsFocused property.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="value">The value to set.</param>
    [<Extension>]
    ...
    /// <summary>Sets the IsPointerOver property.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="value">The value to set.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the GotFocus event.</summary>
    /// <param name="this">Current widget.</param>
    ...
    /// <summary>Listens to the LostFocus event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the KeyDown event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the KeyUp event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the TextInputMethodClientRequested event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerEntered event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerExited event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerMoved event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerPressed event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerReleased event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerCaptureLost event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the PointerWheelChanged event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the Tapped event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
    ...
    /// <summary>Listens to the DoubleTapped event.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="fn">Function to be called when the event is raised.</param>
    [<Extension>]
