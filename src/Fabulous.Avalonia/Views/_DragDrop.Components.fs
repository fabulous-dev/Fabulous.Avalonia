...
type ComponentDragDropModifiers =
    ...
    [<Extension>]
    static member inline onDragEnter(this: WidgetBuilder<unit, #IFabInteractive>, fn: DragEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onDragLeave(this: WidgetBuilder<unit, #IFabInteractive>, fn: DragEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onDragOver(this: WidgetBuilder<unit, #IFabInteractive>, fn: DragEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onDrop(this: WidgetBuilder<unit, #IFabInteractive>, fn: DragEventArgs -> unit) =
