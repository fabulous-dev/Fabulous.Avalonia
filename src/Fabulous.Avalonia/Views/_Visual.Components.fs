...
type ComponentVisualModifiers =
    ...
    [<Extension>]
    static member inline onAttachedToVisualTree(this: WidgetBuilder<unit, #IFabVisual>, fn: VisualTreeAttachmentEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onDetachedFromVisualTree(this: WidgetBuilder<unit, #IFabVisual>, fn: VisualTreeAttachmentEventArgs -> unit) =
...
type ComponentVisualExtraModifiers =
    ...
    [<Extension>]
    static member inline opacityMask(this: WidgetBuilder<unit, #IFabVisual>, value: Color) =
    ...
    /// <param name="value">The OpacityMask value.</param>
    [<Extension>]
    static member inline opacityMask(this: WidgetBuilder<unit, #IFabVisual>, value: string) =
        VisualModifiers.opacityMask(this, View.SolidColorBrush(value))
