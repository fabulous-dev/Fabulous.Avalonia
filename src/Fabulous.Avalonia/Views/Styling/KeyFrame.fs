...
module KeyFrameBuilders =
    ...
    type Fabulous.Avalonia.View with
        ...
        /// <summary>Creates a new KeyFrame widget
        /// <param name="setters">The setters to apply to the KeyFrame.</param>
        /// <example>
        /// <code lang="fsharp">
        /// Border()
        ///     .styles() {
        ...
        ///         Animations() {
        ///             Animation(...) {
        ///                KeyFrame(Rotate3DTransform.AngleXProperty, 0.)
        ///             }
        ///     }
        /// </code>
        /// </example>
...
type KeyFrameModifiers =
    ...
    /// <summary>Links a ViewRef to access the direct KeyFrame control instance.</summary>
    /// <param name="this">Current widget.</param>
