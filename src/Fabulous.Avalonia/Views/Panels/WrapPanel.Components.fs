...
module ComponentWrapPanelBuilders =
    type Fabulous.Avalonia.View with
        ...
        static member VWrap() =
            CollectionBuilder<'msg, IFabWrapPanel, IFabControl>(WrapPanel.WidgetKey, ComponentPanel.Children, WrapPanel.Orientation.WithValue(Orientation.Vertical))
        ...
        /// (including any margins and borders). See <seealso href="https://docs.avaloniaui.net/docs/reference/controls/detailed-reference/wrappanel" />.</summary>
        static member HWrap() =
            CollectionBuilder<'msg, IFabWrapPanel, IFabControl>(WrapPanel.WidgetKey, ComponentPanel.Children, WrapPanel.Orientation.WithValue(Orientation.Horizontal))