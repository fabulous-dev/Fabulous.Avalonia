...
module MvuToolTip =
    ...
    let Opening =
        Attributes.Mvu.defineRoutedEvent "ToolTip_TipWidget" ToolTip.ToolTipOpeningEvent

    let Closing =
        Attributes.Mvu.defineRoutedEventNoArg "ToolTip_TipWidget" ToolTip.ToolTipClosingEvent
