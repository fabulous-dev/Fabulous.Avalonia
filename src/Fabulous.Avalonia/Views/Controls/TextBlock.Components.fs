...
module ComponentTextBlock =
    let TextDecorations =
        Attributes.defineAvaloniaListWidgetCollectionNoDispatch "TextBlock_TextDecorations" (fun target ->
    ...
    let Inlines =
        Attributes.defineAvaloniaListWidgetCollectionNoDispatch "TextBlock_Inlines" (fun target ->
            let target = target :?> TextBlock
