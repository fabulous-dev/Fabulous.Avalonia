...
type ComponentPopupModifiers =
    ...
    [<Extension>]
    static member inline onClosed(this: WidgetBuilder<unit, #IFabPopup>, msg: unit -> unit) =
    ...
    [<Extension>]
    static member inline onOpened(this: WidgetBuilder<unit, #IFabPopup>, msg: unit -> unit) =
