...
module AutomationProperties =
    let AcceleratorKey = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.AcceleratorKeyProperty
    
    let AccessibilityView = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.AccessibilityViewProperty
    
    let AccessKey = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.AccessKeyProperty
    
    let AutomationId = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.AutomationIdProperty
    
    let ControlTypeOverride = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.ControlTypeOverrideProperty
    
    let HelpText = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.HelpTextProperty
    
    let IsIsColumnHeader = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.IsColumnHeaderProperty
    
    let IsRequiredForForm = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.IsRequiredForFormProperty
    
    let IsRowHeader = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.IsRowHeaderProperty
    
    let IsOffscreenBehavior = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.IsOffscreenBehaviorProperty
    
    let ItemStatus = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.ItemStatusProperty
    
    let ItemType = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.ItemTypeProperty
    
    let LiveSetting = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.LiveSettingProperty
    
    let Name = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.NameProperty
    
    let PositionInSet = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.PositionInSetProperty
    
    let SizeOfSet = Attributes.defineAvaloniaPropertyWithEquality AutomationProperties.SizeOfSetProperty
