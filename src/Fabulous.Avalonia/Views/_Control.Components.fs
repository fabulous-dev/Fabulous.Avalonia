...
type ComponentControlModifiers =
    ...
    [<Extension>]
    static member inline onContextRequested(this: WidgetBuilder<unit, #IFabControl>, fn: ContextRequestedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onRequestBringIntoView(this: WidgetBuilder<unit, #IFabControl>, fn: RequestBringIntoViewEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onLoaded(this: WidgetBuilder<unit, #IFabControl>, fn: RoutedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onUnLoaded(this: WidgetBuilder<unit, #IFabControl>, fn: RoutedEventArgs -> unit) =
    ...
    [<Extension>]
    static member inline onSizeChanged(this: WidgetBuilder<unit, #IFabControl>, fn: SizeChangedEventArgs -> unit) =
