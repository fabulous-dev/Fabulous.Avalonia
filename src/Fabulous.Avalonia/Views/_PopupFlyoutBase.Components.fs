...
type ComponentPopupFlyoutBaseModifiers =
    ...
    [<Extension>]
    static member inline onOpening(this: WidgetBuilder<unit, #IFabPopupFlyoutBase>, fn: unit -> unit) =
    ...
    [<Extension>]
    static member inline onClosing(this: WidgetBuilder<unit, #IFabPopupFlyoutBase>, fn: CancelEventArgs -> unit) =
