...
module MvuMenuItemsBuilders =
    type Fabulous.Avalonia.Mvu.View with
        ...
        /// <param name="header">The header of the menu item.</param>
        /// <param name="onClick">Raised when the menu item is clicked.</param>
        static member MenuItems(header: WidgetBuilder<'msg, #IFabMvuControl>, onClick: RoutedEventArgs -> 'msg) =
            CollectionBuilder<'msg, IFabMvuMenuItem, IFabMvuMenuItem>(
                MenuItem.WidgetKey,
                MvuItemsControl.Items,
                AttributesBundle(
        ...
        static member inline MenuItems(onClick: RoutedEventArgs -> 'msg) =
            CollectionBuilder<'msg, IFabMvuMenuItem, IFabMvuMenuItem>(MenuItem.WidgetKey, MvuItemsControl.Items, MvuMenuItem.Clicked.WithValue(onClick))
