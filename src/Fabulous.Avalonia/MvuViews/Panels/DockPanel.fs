...
module MvuDockPanelBuilders =
    type Fabulous.Avalonia.Mvu.View with
        ...
        static member Dock() =
            CollectionBuilder<'msg, IFabMvuDockPanel, IFabMvuControl>(DockPanel.WidgetKey, MvuPanel.Children, DockPanel.LastChildFill.WithValue(true))
        ...
        static member Dock(lastChildFill: bool) =
            CollectionBuilder<'msg, IFabMvuDockPanel, IFabMvuControl>(DockPanel.WidgetKey, MvuPanel.Children, DockPanel.LastChildFill.WithValue(lastChildFill))
