...
type MvuDragDropModifiers =
    ...
    [<Extension>]
    static member inline onDragEnter(this: WidgetBuilder<'msg, #IFabMvuDragDrop>, fn: DragEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onDragLeave(this: WidgetBuilder<'msg, #IFabMvuDragDrop>, fn: DragEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onDragOver(this: WidgetBuilder<'msg, #IFabMvuDragDrop>, fn: DragEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onDrop(this: WidgetBuilder<'msg, #IFabMvuDragDrop>, fn: DragEventArgs -> 'msg) =
