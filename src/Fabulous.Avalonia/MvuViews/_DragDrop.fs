...
type MvuDragDropModifiers =
    ...
    [<Extension>]
    static member inline onDragEnter(this: WidgetBuilder<'msg, #IFabMvuInteractive>, fn: DragEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onDragLeave(this: WidgetBuilder<'msg, #IFabMvuInteractive>, fn: DragEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onDragOver(this: WidgetBuilder<'msg, #IFabMvuInteractive>, fn: DragEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onDrop(this: WidgetBuilder<'msg, #IFabMvuInteractive>, fn: DragEventArgs -> 'msg) =
