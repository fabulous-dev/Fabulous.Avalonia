...
type FlyoutBaseModifiers =
    ...
    [<Extension>]
    static member inline onOpened(this: WidgetBuilder<'msg, #IFabMvuFlyoutBase>, msg: 'msg) =
    ...
    [<Extension>]
    static member inline onClosed(this: WidgetBuilder<'msg, #IFabMvuFlyoutBase>, msg: 'msg) =
