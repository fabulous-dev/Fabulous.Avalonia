...
type MvuTopLevelModifiers =
    ...
    [<Extension>]
    static member inline onActualThemeVariantChanged(this: WidgetBuilder<'msg, #IFabMvuTopLevel>, fn: 'msg) =
    ...
    [<Extension>]
    static member inline onOpened(this: WidgetBuilder<'msg, #IFabMvuTopLevel>, fn: 'msg) =
    ...
    [<Extension>]
    static member inline onClosed(this: WidgetBuilder<'msg, #IFabMvuTopLevel>, fn: 'msg) =
    ...
    [<Extension>]
    static member inline onBackRequested(this: WidgetBuilder<'msg, #IFabMvuTopLevel>, fn: RoutedEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline onScalingChanged(this: WidgetBuilder<'msg, #IFabMvuTopLevel>, fn: 'msg) =
