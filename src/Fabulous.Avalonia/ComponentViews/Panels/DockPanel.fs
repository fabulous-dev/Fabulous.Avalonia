...
module ComponentDockPanelBuilders =
    type Fabulous.Avalonia.Components.View with
        ...
        static member Dock() =
            CollectionBuilder<unit, IFabComponentDockPanel, IFabComponentControl>(DockPanel.WidgetKey, ComponentPanel.Children, DockPanel.LastChildFill.WithValue(true))
        ...
        static member Dock(lastChildFill: bool) =
            CollectionBuilder<unit, IFabComponentDockPanel, IFabComponentControl>(DockPanel.WidgetKey, ComponentPanel.Children, DockPanel.LastChildFill.WithValue(lastChildFill))
