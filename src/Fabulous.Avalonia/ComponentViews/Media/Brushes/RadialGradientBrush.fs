...
type ComponentRadialGradientBrushModifiers =

    /// <summary>Link a ViewRef to access the direct RadialGradientBrush control instance.</summary>
    /// <param name="this">Current widget.</param>
    /// <param name="value">The ViewRef instance that will receive access to the underlying control.</param>
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabComponentRadialGradientBrush>, value: ViewRef<RadialGradientBrush>) =
