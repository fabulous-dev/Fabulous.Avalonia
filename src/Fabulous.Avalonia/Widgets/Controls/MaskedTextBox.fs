...
module MaskedTextBox =
    ...
    let AsciiOnly = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.AsciiOnlyProperty
    
    let Culture = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.CultureProperty
    
    let HidePromptOnLeave = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.HidePromptOnLeaveProperty
    
    let MaskCompleted = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.MaskCompletedProperty
    
    let MaskFull = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.MaskFullProperty
    
    let Mask = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.MaskProperty
    
    let PasswordChar = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.PasswordCharProperty
    
    let PromptChar = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.PromptCharProperty
    
    let ResetOnPrompt = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.ResetOnPromptProperty
    
    let ResetOnSpace = Attributes.defineAvaloniaPropertyWithEquality MaskedTextBox.ResetOnSpaceProperty
