...
module AutoCompleteBox =
    ...
    let SearchText =
        Attributes.defineAvaloniaPropertyWithEquality AutoCompleteBox.SearchTextProperty
...
module AutoCompleteBoxBuilders =
    type Fabulous.Avalonia.View with
        ...
        static member AutoCompleteBox(items: string list) =
            WidgetBuilder<'msg, IFabAutoCompleteBox>(AutoCompleteBox.WidgetKey, AutoCompleteBox.Items.WithValue(items))
