...
module Popup =
    ...
    let Child =
        Attributes.defineAvaloniaPropertyWidget Popup.ChildProperty
        
    let InheritsTransform =
        Attributes.defineAvaloniaPropertyWithEquality Popup.InheritsTransformProperty
        
    let IsOpen =
        Attributes.defineAvaloniaPropertyWithEquality Popup.IsOpenProperty
    ...
    let Topmost =
        Attributes.defineAvaloniaPropertyWithEquality Popup.TopmostProperty
