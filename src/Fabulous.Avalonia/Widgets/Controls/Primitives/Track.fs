...
module Track =
    ...
    let Minimum =
        Attributes.defineAvaloniaPropertyWithEquality Track.MinimumProperty
        
    let Maximum =
        Attributes.defineAvaloniaPropertyWithEquality Track.MaximumProperty
        
    let Value =
        Attributes.defineAvaloniaPropertyWithEquality Track.ValueProperty
    ...
    let Thumb =
        Attributes.defineAvaloniaPropertyWidget Track.ThumbProperty
